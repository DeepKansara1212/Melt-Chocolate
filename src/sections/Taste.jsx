      ...
      <div className="flex justify-center items-center h-full relative">
        <div className="relative">
          <img
            src={Caramel}
            alt="Caramel" 
            className="img-1 max-w-68 transform rotate-55 z-1"
          />
        ...
        <div className="absolute z-0">
          <img
            src={Caramel1}
            alt="Caramel"
            className="img-2 max-w-68 transform rotate-55"
          />
          <div className="absolute top-10 -left-35 flex items-end gap-8">
            <span className="taste-text text-2 font-accent font-bold tracking-tight text-[40px]">
              Crunchy
            </span>
            <svg
              width="118"
        ...
        <div className="absolute -z-1">
          <img
            src={Caramel2}
            alt="Caramel"
            className="img-3 max-w-68 transform rotate-55"
          />
          <div className="absolute top-112 left-25 flex items-start gap-3">
            ...
            <span className="taste-text text-3 font-accent font-bold tracking-tight text-[40px] pt-16 whitespace-nowrap">
              Satisfying
            </span>
          </div>
        </div>
        ...
        <div className="absolute -z-2">
          <img
            src={Caramel3}
            alt="Caramel"
            className="img-4 max-w-68 transform rotate-55"
          />
          <div className="absolute top-86 -left-105 flex items-end gap-8">
            <span className="taste-text text-4 font-accent font-bold tracking-tight text-[40px] pb-6">
              Balanced
            </span>
            <svg
              width="113"
