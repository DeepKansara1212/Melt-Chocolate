    ...
    <>
      <div className="text-center text-brown pt-20 pb-24">
        <h1 className="text-8xl font-bold leading-28">
          Four <span className="text-brown">Flavors</span>
        </h1>
      ...
      <div className="flex justify-center items-start gap-6">
        <div>
          <img
            ...
            alt="Caramel"
            className="relative z-10 caremel-choco max-w-72.5 mt-18 drop-shadow-[0_10px_40px_rgba(255, 107, 87, 0.5)]"
          />
        </div>
        <div>
          <img
            ...
            alt="Cocoa"
            className="relative z-10 cocoa-choco max-w-72.5 drop-shadow-[0_10px_40px_rgba(72, 156, 211, 0.5)]"
          />
        </div>
        <div>
          <img
            ...
            alt="Orange"
            className="relative z-10 orange-choco max-w-72.5 drop-shadow-[0_10px_40px_rgba(253, 211, 38, 0.5)]"
          />
        </div>
        <div className="relative">
          <img
            ...
            alt="Almond"
            className="relative z-10 almond-choco max-w-72.5 mt-18 drop-shadow-[0_10px_40px_rgba(157, 156, 61, 0.5)]"
          />

          <img
            src={Stamp}
            alt="Stamp"
            className="stamp absolute z-10 max-w-37.5 -top-10 -left-20 transform rotate-32"
          />
        </div>
      </div>
    </>
